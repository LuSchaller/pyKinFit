...
PYBIND11_MODULE(fitAssignment, m) {
    m.doc() = "pybind11 example plugin"; // optional module docstring

    m.def("setbestcombi", &setbestcombi, "A function that sets the best combination of jets based on the chi2 value of the kinematic fit", py::arg("inputdata"), py::arg("gendata"),);
